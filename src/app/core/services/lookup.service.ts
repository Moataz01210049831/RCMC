...
const DUMMY_COUNTRIES: LookupItem[] = [
...
export class LookupService {
  ...
  getCities() {
    return of(DUMMY_CITIES);
    // TODO: return this.http.get<LookupItem[]>(`${this.apiUrl}/Lookups/Cities`);
  }

  getCountries() {
    return of(DUMMY_COUNTRIES);
    // TODO: return this.http.get<LookupItem[]>(`${this.apiUrl}/Lookups/Countries`);
  }

  getRegions() {
    return of(DUMMY_REGIONS);
    // TODO: return this.http.get<LookupItem[]>(`${this.apiUrl}/Lookups/Regions`);
  }
}
